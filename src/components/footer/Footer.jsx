      ...
      <div className="container">
        <div className="footer__row">
          ...
          <div className="footer__block">
            ...
            <a href="http://t.me/ooo_rauto"><img className='social_icon' src={telegram_i} alt="telegram" /></a>
            <a href="https://www.instagram.com/rauto.uz/"><img className='social_icon' src={instagram_i} alt="instagram" /></a>
            <a href="https://www.facebook.com/Retailauto.uz/"><img className='social_icon' src={facebook_i} alt="facebook" /></a>
